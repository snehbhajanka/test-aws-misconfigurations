...
# SECURITY FIX: Changed from public-read-write to private to prevent public write access
...
# SECURITY FIX: Removed public write permissions (PutObject, DeleteObject) to prevent public write access
...
output "security_warnings" {
  value = "WARNING: This bucket is intentionally misconfigured with no encryption and no versioning, but public write access has been blocked for security!"
}
