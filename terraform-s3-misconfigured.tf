...
# SECURITY FIX: Block public write access
...
# SECURITY FIX: Restricted bucket policy - read-only for demonstration
...
output "security_warnings" {
  value = "SECURE: This bucket now blocks public write access. Public read access is still allowed for demonstration purposes."
}
