...
# SECURITY FIX: Private ACL to prevent public access
...
output "security_warnings" {
  value = "SECURITY FIXED: S3 bucket now blocks public write access with enabled public access block settings and private ACL!"
}
