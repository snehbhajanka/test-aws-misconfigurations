...
# FIXED: Restricted bucket policy (blocks public write access)
...
output "security_warnings" {
  value = "FIXED: This bucket now blocks public write access through Block Public Access settings, private ACL, and restricted bucket policy!"
}
